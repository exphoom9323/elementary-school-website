                ...
                <ol class="breadcrumb text-right">
                    <li class="active">
                      <div class="d-flex justify-content-end mb-2">
                        <a href="{{route('personnel.create')}}" class="btn btn-success ">เพิ่มบุคลากร</a>
                    </div>
                  </li>
                </ol>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">ตารางบุคลากร</strong>
                            </div>
                            <div class="card-body">
                                @if($users->count()>0)
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                                ...
                                                @foreach($users as $user) <!-- $Categort คือ sql จาก web.php  -->
                                                    <tr>
                                                      ...
                                                      <td>
                                                          <form class="edit_form" action="{{route('personnel.edit',$user->id)}}" >
                                                              @csrf
                                                      ...
                                                      <td>
                                                          <form class="delete_form" action="{{route('personnel.destroy',$user->id)}}" method="post">
                                                              @csrf
