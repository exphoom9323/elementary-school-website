                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">รูปภาพในอัลบั้ม</strong>
                                </div>
                                <div class="card-body">
                                    ...
                                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                          @foreach($albumimages as $albumimage) <!-- $Categort คือ sql จาก web.php  -->
                                          <tr>
                                                <td>
                                                    <img src="../../storage/{{$albumimage->image}}" alt="" width="200px" height="200px">
                                                </td>
                                                  <td>
                                                      <form class="delete_form" action="{{route('albumimage.destroy',$albumimage->id)}}" method="post">
                                                          @csrf
